define(function(require, exports, module) {
  ...
  function Random( womb , params ){
    ...
    this.mesh.scale.multiplyScalar( 100 );
    ...
    this.world.update = function(){
      ...
      if( self.updateSeed ==  true ){
        ...
        self.uniforms.seed.value.x = ( Math.sin( self.uniforms.time.value / 1000.0 ) -1.0 ) / 2;
        self.uniforms.seed.value.y = ( Math.cos( self.uniforms.time.value / 1000.0 ) -1.0 ) / 2;
        self.uniforms.seed.value.z = ( Math.cos( self.uniforms.time.value / 3000.0 ) -1.0 ) / 0;
