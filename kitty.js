define(function(require, exports, module) {
  ...
  */
  womb = new Womb({
    ...
    textCreator:      true,
    title:            'STAY SHINY!',
    summary:          "Drag to spin, scroll to zoom,<br/> press 'x' to hide interface",
    gui:              true,
    stats:            true,
  });
  ...
  womb.stream = womb.audioController.createStream( '/wombs/lib/audio/tracks/mirrorMaru.mp3' );
  ...
  womb.JSONLoader.loadFile( '../lib/models/animals/deer.js' , function(){
  ...
  womb.start = function(){
    ...
    */
    ...
    womb.uShiny.image.value     = womb.textTexture;
    ...
    */
    ...
    womb.materialShiny = new THREE.ShaderMaterial( {
      ...
      vertexShader: vertexShaders.audio.noise.position,
      fragmentShader: fragmentShaders.audio.color.image.sub_uv_absdiamond,
      transparent:true,
      fog: true,
      blending: THREE.AdditiveBlending,
      opacity:.1
